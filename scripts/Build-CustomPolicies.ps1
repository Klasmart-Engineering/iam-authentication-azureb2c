...
try{
    ...
    Write-Output "AppSettingsFile $AppSettingsFile"
    ...
    Write-Output "Files found: $XmlPolicyFiles"
    ...
    {
        Write-Output "ENVIRONMENT: $($entry.Name)"
        ...
        if($null -eq $entry.PolicySettings){
            ...
            foreach($file in $XmlPolicyFiles)
            {
                ...
                Write-Output "FILE: $($entry.Name) - $file"
                ...
                {
                    Write-Output "KEY: $key VALUE: $($policySettingsHash[$key])"
